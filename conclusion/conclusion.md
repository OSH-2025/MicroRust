...
- 在测试时，我们采用了多台虚拟机模拟分布式系统。我们将主机的IPFS节点设置为中枢节点，将虚拟机的IPFS节点与主机的IPFS节点相连。(图片）
4，**基础操作**
...
2. 2. docx：我们通过已有的docx库提取docx文本内容后进行标签提取
...
- 代码兼容性不好，要插入其他组件如按钮，显示板困难，上传文件无法拖拽，UI固定且较为简单，传输信息，且无法轻易对于前端外观进行修改，时序修改困难p7
